      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Text(
                'Meter Awal', // Menampilkan nomor pam
                style: blackTextStyle.copyWith(
                  fontWeight: semiBold,
                ),
              ),
              const Spacer(),
              Text(
                'Meter Sekarang', // Menampilkan pemili pam
                style: blackTextStyle.copyWith(
                  fontWeight: semiBold,
                ),
              ),
          ...
          Row(
            children: [
              Text(
                tagihan.meterAwal, // Menampilkan nomor pam
                style: blackTextStyle.copyWith(
                  fontWeight: semiBold,
                ),
              ),
          ...
          Row(
            children: [
              Text(
                'Pemakain Air', // Menampilkan nomor pam
                style: blackTextStyle.copyWith(
                  fontWeight: semiBold,
                ),
              ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 4), // Spasi antara teks
                  Text(
                    'Tipe', // Teks tambahan di sini
                    style: blackTextStyle.copyWith(
                      fontWeight: FontWeight.bold,
                    ),
                  ),
